    ...
    <div>
      <form onSubmit={handleSubmit(onSubmit)} className='bg-white grid gap-10 w-fit p-10 rounded-xl shadow relative'>
        ...
        <div className='flex justify-between text-xs gap-6 mb-20'>
          ...
          <div  onClick={()=> navigate('/') } className="absolute bottom-8 -right-16 bg-blue-200 text-blue-900 p-4 cursor-pointer hover:rounded-2xl transition-all">
            <FaHouseChimney >Volver a la pagina principal</FaHouseChimney>
          </div>
      </form>
    </div>
